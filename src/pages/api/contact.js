...
async function sendNotification({ name, email, phone, message }) {
  ...
  await resend.emails.send({
    ...
    to: NOTIFY_EMAILS,
    reply_to: email,
    subject: `New message from ${name} — CERD-UG Website`,
    html: `
      <div style="font-family:sans-serif;max-width:560px;margin:0 auto;color:#1a1a1a;">
        ...
        <div style="padding:2rem;border:1px solid #e5e7eb;border-top:none;">
          <table style="width:100%;border-collapse:collapse;font-size:0.9rem;">
            <tr><td style="padding:0.5rem 0;color:#6b7280;width:100px;">Name</td><td style="padding:0.5rem 0;font-weight:600;">${name}</td></tr>
            <tr><td style="padding:0.5rem 0;color:#6b7280;">Email</td><td style="padding:0.5rem 0;"><a href="mailto:${email}" style="color:#0C3C01;">${email}</a></td></tr>
            ${phone ? `<tr><td style="padding:0.5rem 0;color:#6b7280;">Phone</td><td style="padding:0.5rem 0;">${phone}</td></tr>` : ''}
          </table>
